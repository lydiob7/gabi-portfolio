            ...
            },
            {
                ...
                content: [
                    ...
                    },
                    {
                        type: 'paragraph',
                        content:
                            'We need to understand what it means for a product to live on the blockchain and the implications and benefits of doing it in this ecosystem and not in the current one ( web2).',
                        size: '200',
                        weight: '500',
                        style: 'normal'
                    },
                    ...
                    {
                        type: 'video',
                        content: { src: 'https://www.youtube.com/embed/AKBmmVCL87U', alt: 'Daomos 2' }
                    },
                    {
                        type: 'paragraph',
                        content:
                    ...
                    {
                        type: 'video',
                        content: { src: 'https://www.youtube.com/embed/nvhYqMqH-bQ', alt: 'Daomos 3' }
                    },
                    {
                        type: 'paragraph',
                        content:
                    ...
                    {
                        type: 'paragraph',
                        content: 'Some insights of our research',
                        size: '200',
                        weight: '500',
                        style: 'normal'
                    },
            ...
            },
            {
                ...
                content: [
                    ...
                    },
                    {
                        ...
                        size: 'auto',
                        content: [
                            { src: daomos6, alt: 'Daomos 6' },
                            { src: daomos7, alt: 'Daomos 7' }
                        ]
                    }
                ]
            },
            ...
            },
            {
                ...
                content: [
                    ...
                    },
                    {
                        type: 'paragraph',
                        content:
                            'Por último, realizamos 36 encuestas para entender por qué un usuario elegiría o no un producto basado en la web3. Estas son algunas de las opiniones de nuestros usuarios.',
                        size: '200',
                        weight: '500',
                        style: 'normal'
                    },
                    ...
                    {
                        type: 'paragraph',
                        content: 'Algunos datos de nuestra investigación',
                        size: '200',
                        weight: '500',
                        style: 'normal'
                    },
